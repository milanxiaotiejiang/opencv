...
public class OpencvFaceActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.opencv_face);
    ...
    @Override
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {//3
